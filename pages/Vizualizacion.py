...
with st.container():
    ...
    if datos_inventario:
        ...
        with columna_dos:
            ...
            # Configuraciones adicionales del gráfico de barras
            ...
            with st.container():
                ...
                # Configuraciones adicionales del gráfico de barras horizontal
                fig_bar.update_traces(
                    textfont_size=12,
                    textangle=0,
                    textposition="outside",
...
with st.container():
    ...
    if salida_data:
        ...
        with columna_uno:
            # Gráfico de pastel para mostrar la proporción de movimientos por producto
        ...
        with columna_dos:
            ...
            # Crear gráfico de barras para mostrar el valor total de productos por tipo de movimiento
            ...
            if not df_salida.empty:
                # Mostrar el gráfico de barras solo si hay datos
                st.plotly_chart(fig_bar, use_container_width=True)
            else:
